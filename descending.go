...
func descending(K *tabKaryawan, n int) {
	var opsi string
	if exit == false {
		fmt.Println("[]============================================[]")
		...
		if opsi == "1" {
			descendingSort(K, n, 1)
		} else if opsi == "2" {
			descendingSort(K, n, 2)
		} else if opsi == "3" {
			descendingSort(K, n, 3)
		} else if opsi == "4" {
			descendingSort(K, n, 4)
		} else if opsi == "5" {
			descendingSort(K, n, 5)
		} else if opsi == "6" {
			descendingSort(K, n, 6)
		} else if opsi == "0" {
			menuMenampilkanData()
		}
		menampilkanData(*K, n)
